...
(function initVisitorTracker() {
  ...
  function detectarProcesadorPC(so, ua) {
    ...
    if (/intel/i.test(uaLower)) {
      ...
      if (/i7-5[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i7';
      if (/i7-4[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i7';
      if (/i7-3[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i7';
      if (/i7-2[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i7';
      ...
      if (/i5-5[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i5';
      if (/i5-4[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i5';
      if (/i5-3[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i5';
      if (/i5-2[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i5';
      ...
      if (/i3-9[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i3';
      if (/i3-8[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i3';
      if (/i3-7[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i3';
      if (/i3-6[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i3';
      if (/i3-5[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i3';
      if (/i3-4[0-9]{3,4}/i.test(uaLower)) return 'Intel Core i3';
  ...
  function detectarProcesadorCelular(ua) {
    ...
    // Detección por patrón genérico
    if (/snapdragon/i.test(uaLower)) {
      if (/8 gen/i.test(uaLower)) return 'Snapdragon 8 Series';
      if (/7 gen/i.test(uaLower)) return 'Snapdragon 7 Series';
      if (/6/i.test(uaLower)) return 'Snapdragon 6 Series';
      if (/4/i.test(uaLower)) return 'Snapdragon 4 Series';
      return 'Snapdragon (no especificado)';
    }

    if (/dimensity/i.test(uaLower)) {
      if (/9/i.test(uaLower)) return 'MediaTek Dimensity 9 Series';
      if (/8/i.test(uaLower)) return 'MediaTek Dimensity 8 Series';
      if (/7/i.test(uaLower)) return 'MediaTek Dimensity 7 Series';
      return 'MediaTek Dimensity (no especificado)';
    }

    if (/helio/i.test(uaLower)) {
      if (/g9/i.test(uaLower)) return 'MediaTek Helio G9 Series';
      if (/g8/i.test(uaLower)) return 'MediaTek Helio G8 Series';
      if (/g7/i.test(uaLower)) return 'MediaTek Helio G7 Series';
      if (/p9/i.test(uaLower)) return 'MediaTek Helio P9 Series';
      return 'MediaTek Helio (no especificado)';
    }

    if (/exynos/i.test(uaLower)) {
      if (/24/i.test(uaLower)) return 'Samsung Exynos 2400 Series';
      if (/22/i.test(uaLower)) return 'Samsung Exynos 2200 Series';
      if (/21/i.test(uaLower)) return 'Samsung Exynos 2100 Series';
      if (/990/i.test(uaLower)) return 'Samsung Exynos 990';
      return 'Samsung Exynos (no especificado)';
    }

    if (/kirin/i.test(uaLower)) {
      if (/9000/i.test(uaLower)) return 'HiSilicon Kirin 9000 Series';
      if (/990/i.test(uaLower)) return 'HiSilicon Kirin 990';
      if (/980/i.test(uaLower)) return 'HiSilicon Kirin 980';
      return 'HiSilicon Kirin (no especificado)';
    }

    if (/tensor/i.test(uaLower)) {
      if (/g3/i.test(uaLower)) return 'Google Tensor G3';
      if (/g2/i.test(uaLower)) return 'Google Tensor G2';
      return 'Google Tensor';
    }

    if (/a17 pro/i.test(uaLower)) return 'Apple A17 Pro';
    if (/a17/i.test(uaLower)) return 'Apple A17';
    if (/a16/i.test(uaLower)) return 'Apple A16 Bionic';
    if (/a15/i.test(uaLower)) return 'Apple A15 Bionic';
    if (/a14/i.test(uaLower)) return 'Apple A14 Bionic';
    if (/a13/i.test(uaLower)) return 'Apple A13 Bionic';
    if (/a12/i.test(uaLower)) return 'Apple A12 Bionic';
  ...
  function detectarSistemaOperativo(ua) {
    ...
    if (/windows nt 10\.0/i.test(uaLower)) {
      if (/windows nt 10\.0; win64; x64/i.test(uaLower)) {
        // Intentar detectar edición específica
        if (/pro/i.test(uaLower)) return 'Windows 11 Pro';
        if (/home/i.test(uaLower)) return 'Windows 11 Home';
        if (/education/i.test(uaLower)) return 'Windows 11 Education';
        if (/enterprise/i.test(uaLower)) return 'Windows 11 Enterprise';
        return 'Windows 11';
      }
    ...
    if (/android/i.test(uaLower)) {
      if (/android 14/i.test(uaLower)) return 'Android 14';
      if (/android 13/i.test(uaLower)) return 'Android 13';
      if (/android 12/i.test(uaLower)) return 'Android 12';
      if (/android 11/i.test(uaLower)) return 'Android 11';
      if (/android 10/i.test(uaLower)) return 'Android 10';
      if (/android 9/i.test(uaLower)) return 'Android 9 Pie';
      if (/android 8\.1/i.test(uaLower)) return 'Android 8.1 Oreo';
      if (/android 8\.0/i.test(uaLower)) return 'Android 8.0 Oreo';
      if (/android 7\.1/i.test(uaLower)) return 'Android 7.1 Nougat';
      if (/android 7\.0/i.test(uaLower)) return 'Android 7.0 Nougat';
      if (/android 6\.0/i.test(uaLower)) return 'Android 6.0 Marshmallow';
      if (/android 5\.1/i.test(uaLower)) return 'Android 5.1 Lollipop';
      if (/android 5\.0/i.test(uaLower)) return 'Android 5.0 Lollipop';
      if (/android 4\.4/i.test(uaLower)) return 'Android 4.4 KitKat';
  ...
  function detectarMarcaModeloCelular(ua) {
    ...
    if (/xiaomi|redmi|poco/i.test(uaLower)) {
      // Buscar código de modelo en la base de datos
      ...
      if (/redmi/i.test(uaLower)) {
        if (/note/i.test(uaLower)) return { marca: 'Xiaomi', modelo: 'Redmi Note Series' };
        if (/12c/i.test(uaLower)) return { marca: 'Xiaomi', modelo: 'Redmi 12C' };
        if (/13c/i.test(uaLower)) return { marca: 'Xiaomi', modelo: 'Redmi 13C' };
        if (/a1/i.test(uaLower)) return { marca: 'Xiaomi', modelo: 'Redmi A1' };
        return { marca: 'Xiaomi', modelo: 'Redmi Series' };
      }
      if (/poco/i.test(uaLower)) return { marca: 'POCO', modelo: 'POCO Series' };
    ...
    if (/samsung/i.test(uaLower)) {
      ...
      if (/galaxy s/i.test(uaLower)) {
        if (/s24/i.test(uaLower)) return { marca: 'Samsung', modelo: 'Galaxy S24 Series' };
        if (/s23/i.test(uaLower)) return { marca: 'Samsung', modelo: 'Galaxy S23 Series' };
        if (/s22/i.test(uaLower)) return { marca: 'Samsung', modelo: 'Galaxy S22 Series' };
        if (/s21/i.test(uaLower)) return { marca: 'Samsung', modelo: 'Galaxy S21 Series' };
        if (/s20/i.test(uaLower)) return { marca: 'Samsung', modelo: 'Galaxy S20 Series' };
        return { marca: 'Samsung', modelo: 'Galaxy S Series' };
      }
      ...
      return { marca: 'Samsung', modelo: 'Samsung Galaxy' };
    }

    // Apple
    if (/iphone/i.test(uaLower)) {
      if (/iphone 15/i.test(uaLower)) return { marca: 'Apple', modelo: 'iPhone 15 Series' };
      if (/iphone 14/i.test(uaLower)) return { marca: 'Apple', modelo: 'iPhone 14 Series' };
      if (/iphone 13/i.test(uaLower)) return { marca: 'Apple', modelo: 'iPhone 13 Series' };
      if (/iphone 12/i.test(uaLower)) return { marca: 'Apple', modelo: 'iPhone 12 Series' };
      if (/iphone 11/i.test(uaLower)) return { marca: 'Apple', modelo: 'iPhone 11 Series' };
    ...
    if (/ipad/i.test(uaLower)) return { marca: 'Apple', modelo: 'iPad' };
    ...
    if (/motorola|moto/i.test(uaLower)) {
      ...
      if (/g/i.test(uaLower)) return { marca: 'Motorola', modelo: 'Moto G Series' };
    ...
    if (/vivo/i.test(uaLower)) {
      ...
      if (/v/i.test(uaLower)) return { marca: 'Vivo', modelo: 'Vivo V Series' };
      if (/y/i.test(uaLower)) return { marca: 'Vivo', modelo: 'Vivo Y Series' };
      return { marca: 'Vivo', modelo: 'Vivo Smartphone' };
    }

    // Oppo
    if (/oppo/i.test(uaLower)) {
      if (/reno/i.test(uaLower)) return { marca: 'OPPO', modelo: 'Reno Series' };
      if (/a/i.test(uaLower)) return { marca: 'OPPO', modelo: 'OPPO A Series' };
      return { marca: 'OPPO', modelo: 'OPPO Smartphone' };
    }

    // Realme
    if (/realme/i.test(uaLower)) {
      if (/gt/i.test(uaLower)) return { marca: 'Realme', modelo: 'GT Series' };
      if (/number/i.test(uaLower)) return { marca: 'Realme', modelo: 'Number Series' };
      return { marca: 'Realme', modelo: 'Realme Smartphone' };
    }

    // Huawei
    if (/huawei/i.test(uaLower)) {
      if (/p40/i.test(uaLower)) return { marca: 'Huawei', modelo: 'P40 Series' };
      if (/p30/i.test(uaLower)) return { marca: 'Huawei', modelo: 'P30 Series' };
      if (/mate/i.test(uaLower)) return { marca: 'Huawei', modelo: 'Mate Series' };
      if (/nova/i.test(uaLower)) return { marca: 'Huawei', modelo: 'Nova Series' };
      if (/y/i.test(uaLower)) return { marca: 'Huawei', modelo: 'Y Series' };
      return { marca: 'Huawei', modelo: 'Huawei Smartphone' };
    }

    // Honor
    if (/honor/i.test(uaLower)) {
      if (/magic/i.test(uaLower)) return { marca: 'Honor', modelo: 'Magic Series' };
    ...
    if (/zte/i.test(uaLower)) {
      if (/axon/i.test(uaLower)) return { marca: 'ZTE', modelo: 'Axon Series' };
      if (/blade/i.test(uaLower)) return { marca: 'ZTE', modelo: 'Blade Series' };
      return { marca: 'ZTE', modelo: 'ZTE Smartphone' };
    }

    // Tecno
    if (/tecno/i.test(uaLower)) {
      if (/camon/i.test(uaLower)) return { marca: 'Tecno', modelo: 'Camon Series' };
      if (/spark/i.test(uaLower)) return { marca: 'Tecno', modelo: 'Spark Series' };
      if (/pova/i.test(uaLower)) return { marca: 'Tecno', modelo: 'Pova Series' };
      return { marca: 'Tecno', modelo: 'Tecno Smartphone' };
    }

    // Infinix
    if (/infinix/i.test(uaLower)) {
      if (/note/i.test(uaLower)) return { marca: 'Infinix', modelo: 'Note Series' };
      if (/hot/i.test(uaLower)) return { marca: 'Infinix', modelo: 'Hot Series' };
    ...
    if (/lg/i.test(uaLower)) {
      if (/stylo/i.test(uaLower)) return { marca: 'LG', modelo: 'Stylo Series' };
      if (/v/i.test(uaLower)) return { marca: 'LG', modelo: 'V Series' };
      if (/g/i.test(uaLower)) return { marca: 'LG', modelo: 'G Series' };
      return { marca: 'LG', modelo: 'LG Smartphone' };
    }

    // Sony
    if (/sony/i.test(uaLower)) {
      if (/xperia/i.test(uaLower)) return { marca: 'Sony', modelo: 'Xperia Series' };
      return { marca: 'Sony', modelo: 'Sony Smartphone' };
    }

    // Asus
    if (/asus/i.test(uaLower)) {
      if (/zenfone/i.test(uaLower)) return { marca: 'ASUS', modelo: 'ZenFone Series' };
      if (/rog/i.test(uaLower)) return { marca: 'ASUS', modelo: 'ROG Phone' };
      return { marca: 'ASUS', modelo: 'ASUS Smartphone' };
    }

    // Google Pixel
    if (/pixel/i.test(uaLower)) {
      if (/pixel 8/i.test(uaLower)) return { marca: 'Google', modelo: 'Pixel 8 Series' };
      if (/pixel 7/i.test(uaLower)) return { marca: 'Google', modelo: 'Pixel 7 Series' };
      if (/pixel 6/i.test(uaLower)) return { marca: 'Google', modelo: 'Pixel 6 Series' };
  ...
  function detectarMarcaPC(ua) {
    ...
    if (/toshiba/i.test(uaLower)) return 'Toshiba';
